...
def main():
    ...
    if "calculate_diagonals" in kwargs and kwargs["calculate_diagonals"]: 
        ...
        calculations.calculate_diagonals(nsf_markers_df, cluster_medians, kwargs["output_folder"], kwargs["outputfilename"])
        ...
        calculations.on_target_ratio(adata, nsf_results_df, kwargs["cluster_header"], kwargs["medians_header"], kwargs["output_folder"], kwargs["outputfilename"])
