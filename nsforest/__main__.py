...
def main():
    ...
    # Saving new h5ad
    if to_save: 
        filename = kwargs["filename"].replace(".h5ad", "_" + kwargs["cluster_header"] + "_precalculated.h5ad")
        print("Saving new anndata object as...\n", filename)
        adata.write_h5ad(filename)
    else: 
        print(f'Using pre-calculated cluster_medians and binary_scores in {kwargs["filename"]} from {kwargs["medians_header"]} {kwargs["binary_scores_header"]}')
