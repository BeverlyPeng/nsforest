...
def DecisionTree(adata, cluster_header, cluster_list=None,
                 medians_header = None, binary_scores_header = None, 
                 beta=0.5, n_top_genes=15, n_binary_genes=10, n_genes_eval=6,
                 marker_genes_dict={},
    ...
    for cl in cluster_list[:]:
        ...
        if cl not in marker_genes_dict: 
            continue
        marker_genes = marker_genes_dict[cl]
        # print(cl, marker_genes)
        ...
        # print(len(binary_genes_list))
        # print(binary_genes_list)
        # print(len(top_gene_medians[binary_genes_list]))
        # print(top_gene_medians[binary_genes_list])
